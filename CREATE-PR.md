...
2. If behavior changed, sync docs in the same commit: README.md, CLAUDE.md/AGENTS.md, docs/USAGE.md, docs/HOW-IT-WORKS.md, INSTALL.md, CREATE-PR.md.
3. Run make check and stop if it fails.
4. If provider or live API behavior changed, also run make test-llm-all and stop if it fails.
